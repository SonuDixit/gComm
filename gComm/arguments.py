...
def Arguments():
    ...
    parser.add_argument('--grid_size', type=int, default=4, help='Number of rows (and columns) in the grid world. '
                                                                 ...
                                                                 'maze feature')
    parser.add_argument('--min_other_objects', type=int, default=2,
                        help='Minimum amount of objects to put in the grid world.')
    parser.add_argument('--max_objects', type=int, default=2, help='Maximum number of other objects to put in the grid '
                                                                   'world.')
    ...
    parser.add_argument('--obstacles_flag', type=bool, default=False,
    ...
    parser.add_argument('--enable_maze', type=bool, default=False, help='enable maze-grid (default: False)'
                                                                        'Note: only odd-sized grids possible with '
                                                                        'enable maze feature')
    ...
    parser.add_argument('--type_grammar', type=str, default='simple_trans', required=False,
    ...
    parser.add_argument('--transitive_verbs', type=str, default='push,pull',
    ...
    parser.add_argument('--keep_fixed_weights', type=bool, default=True,
    ...
    parser.add_argument('--all_light', type=bool, default=True, help='make all objects light (wight=1)')
    ...
    parser.add_argument('--use_comm_channel', type=bool, default=False,
    ...
    # ------------------------------------ lights off feature ----------------------------------------- #
    parser.add_argument('--lights_out', type=bool, default=False, help='Darker grid when lights out is True')

    # ----------------------------------- visualisation -----------------------------------------------
    parser.add_argument('--render_episode', type=bool, default=False, help='whether to render every step')
