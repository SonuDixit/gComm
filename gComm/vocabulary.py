...
class Vocabulary(object):
    ...
    TRANSITIVE_VERBS = {"push", "pull", "pickup", "drop"}
    NOUNS = {"circle", "square", "cylinder", "diamond"}
    COLOR_ADJECTIVES = {"green", "red", "blue", "yellow"}
    SIZE_ADJECTIVES = {"small", "big"}

    def __init__(self, intransitive_verbs: Dict[str, str], transitive_verbs: Dict[str, str],
                 nouns: Dict[str, str], color_adjectives: Dict[str, str], size_adjectives: Dict[str, str]):
        all_words = list(intransitive_verbs.keys()) + list(transitive_verbs.keys()) \
    ...
    @classmethod
    def initialize(cls, intransitive_verbs: List[str], transitive_verbs: List[str],
        ...
        return cls(intransitive_verbs, transitive_verbs, nouns, color_adjectives, size_adjectives)

    @classmethod
    def sample(cls, num_intransitive=1, num_transitive=1, num_nouns=3,
